...
class ImageModificationWindow:
    ...
    def _do_preview(self):
        if not self.current_image_path or not os.path.isfile(self.current_image_path):
            ...
            return
        blur, globe, sigma, blend_angle, ge_sector_angle, ge_sector_smoothing, fd_strength, fd_decay, fd_smooth, fd_mode, fd_conductivity, fd_sink, sc_width, sc_min, sc_max, ee_falloff, sc_falloff = self._get_params()
        try:
