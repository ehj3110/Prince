...
'''
        ...
        self.lbl0 = Label(win, text='Rush Power', font='Helvetica 40 bold')
        ...
        self.lbl4 = Label(win, text='Ignore')
        ...
        self.lbl10 = Label(win, text='Ignore')
        self.lbl11 = Label(win, text='Ignore')
        self.lbl11_2 = Label(win, text='Time Per Data Point')
        self.lbl12 = Label(win, text='Ignore', font='Helvetica 12 bold')
        self.lbl13 = Label(win, text='Simple Txt File Generator', font='Helvetica 12 bold')
        self.lbl14 = Label(win, text='Ignore')
        ...
        self.b2 = Button(win, text='Ignore', command=self.set_home)
        self.b3 = Button(win, text='Ignore', command=self.get_position)
        self.b4 = Button(win, text='Stop', command=self.stop)
        self.b5 = Button(win, text='Ignore', command=self.movedown)
        self.b6 = Button(win, text='Ignore', command=self.moveup)
    ...
    def run(self):
        ...
        powers = [255, 225, 200, 175, 150, 125, 100, 75, 50, 40, 35,30, 25, 20, 15, 10, 5, 1, 0]
        #powers = [255, 200, 150, 100]
        idx_list = np.arange(0, len(self.exposure_time), self.cache_clear_layer)
        # This is what runs the code. This loop here is what runs through each layer and runs it based on what we want. It checks each layer if we have hit the stop button with the flag commannd
        for idx in range(len(powers)):
            print(idx)
            self.controller.power(current=powers[idx])
            self.flag = True
            # THIS IS THE PRINTING NAME??????
            self._(0)
        self.controller.changemode(3)
