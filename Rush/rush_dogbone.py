...
'''
        ...
        self.lbl0 = Label(win, text='Rush (For dogbone)', font='Helvetica 40 bold')
    ...
    def run(self):
        ...
        for idx in range(len(self.image_list)):
            ...
            cv2.waitKey(1)
            self.my_ensemble.write_read('MOVEINC Z {} {}'.format((self.thickness[idx] * -1) / 1000,
                                                                 self.thickness[idx] / self.exposure_time[idx]))
